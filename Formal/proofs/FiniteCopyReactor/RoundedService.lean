...
theorem gross_cycle_rounded_upper (V : ℕ) (r d : ℝ) (hV : 0 < (V:ℝ)) (hlarge : 1000000 ≤ V)
  ...
  have h := supply_cycle_upper .gross V r d hV hr hr' hd hd' (1/20) ((V:ℝ)/5-1) (by norm_num) N 0
  apply h.trans
...
theorem joint_rounded_gross_tail (V : ℕ) (r d : ℝ) (hV : 0 < (V:ℝ)) (hlarge : 1000000 ≤ V)
  ...
  have h := gross_cycle_rounded_upper V r d hV hlarge hr hr' hd hd' N
