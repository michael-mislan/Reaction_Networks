...
/-- The literal local generator includes own growth, common-volume growth
caused by the other module, and symmetric cross-catalysis. -/
noncomputable def literal (m : Nat) (v next : Array Int) (i col : Nat)
  ...
  c*(2/5)*((x : ℝ)*(t ((x : Int)-1) ((y : Int)+1)-z)+
    (y : ℝ)*(t ((x : Int)+1) ((y : Int)-1)-z))
