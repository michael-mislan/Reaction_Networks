...
theorem source_window_occupation {n : ℕ} (hn : 2 ≤ n) (cfg : SourceMoleculeFibreConfig n)
  ...
  have he : windowMassIntegral (fun i => 19/10-624*M i) w A B K =
    ...
    ring
  have htime : windowDuration w A B K = 99 := (physical_window_duration z J K a b).trans hab
  rw [he,htime] at hi
