/- Kernel replay of the existing parameter-rich child certificate.
Derived from proofs/DUnstableCores/ParameterRichCounterexample.lean;
finite native_decide checks are replaced by kernel-reduced decide proofs.
Only the child-safety portion is retained. -/
import proofs.DUnstableCores.AlternatingMatchingExchange
...
namespace OscillatoryCores.KernelChildCertificate
...
theorem parameterRichCounterexampleMatching2_matrix :
  ...
  rw [parameterRichCounterexampleMatching2.toChildSelection_matrix]
...
theorem parameterRichCounterexampleMatching3a_matrix :
  ...
  rw [parameterRichCounterexampleMatching3a.toChildSelection_matrix]
...
theorem parameterRichCounterexampleMatching3b_matrix :
  ...
  rw [parameterRichCounterexampleMatching3b.toChildSelection_matrix]
...
theorem parameterRichCounterexampleMatching4_matrix :
  ...
  rw [parameterRichCounterexampleMatching4.toChildSelection_matrix]
...
theorem parameterRichCounterexampleMatching13_matrix :
  ...
  rw [parameterRichCounterexampleMatching13.toChildSelection_matrix]
...
theorem parameterRichCounterexampleMatching23_matrix :
  ...
  rw [parameterRichCounterexampleMatching23.toChildSelection_matrix]
...
end OscillatoryCores.KernelChildCertificate
