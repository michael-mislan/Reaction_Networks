...
/- Literal finite reversible unit chains with nonnegative internal loss.
Transmission remains strict because the reversible outgoing terms keep
every elimination pivot positive, including on the lossless boundary. -/
