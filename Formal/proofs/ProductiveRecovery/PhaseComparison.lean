...
theorem phase_comparison (r d : ℝ) (c : State) (hc : Nonneg c)
    (hr : 19 ≤ r) (hr' : r ≤ 21) (hd : 0 ≤ d) (hd' : d ≤ 1/25)
    (hA : A c ≤ 11/10) (hB : B c ≤ 11/10) :
    -70*c 2+20*c 3+38*c 5 ≤ field r d c 2 ∧
    -70*c 3+20*c 4 ≤ field r d c 3 ∧
    -70*c 4 ≤ field r d c 4 ∧
    -70*c 5+20*c 4 ≤ field r d c 5 := by
  ...
  change -70*c 2+20*c 3+38*c 5 ≤
    -c 2+((1/500000000)*c 0*c 1-(1/5000000000)*c 2)-
      (20*c 2*c 0-20*c 3)+2*(r*(c 5-c 2^2))-
      (d*c 2-d*(1/8000000000)*c 0*c 1) ∧
    -70*c 3+20*c 4 ≤ -c 3+(20*c 2*c 0-20*c 3)-(20*c 3*c 1-20*c 4) ∧
    -70*c 4 ≤ -c 4+(20*c 3*c 1-20*c 4)-(20*c 4-2*c 5) ∧
    -70*c 5+20*c 4 ≤ -c 5+(20*c 4-2*c 5)-r*(c 5-c 2^2)
  constructor
  · nlinarith [hc 2]
  constructor
  · nlinarith [hc 3]
