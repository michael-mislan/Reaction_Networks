...
/-- Phase comparison with distinct diagonal losses `(48, 43, 41, 24)` on the
column `(x, c₁, c₂, z)`; the `x` row is the sharp one, the other rows keep the
actual self-decay of each species. -/
theorem fine_phase_comparison (r d : ℝ) (c : State) (hc : Nonneg c)
    (hr : 19 ≤ r) (hr' : r ≤ 21) (hd : 0 ≤ d) (hd' : d ≤ 1/25)
    (hA : A c ≤ 11/10) (hB : B c ≤ 11/10) :
    -48*c 2+20*c 3+38*c 5 ≤ field r d c 2 ∧
    -43*c 3+20*c 4 ≤ field r d c 3 ∧
    -41*c 4+2*c 5 ≤ field r d c 4 ∧
    -24*c 5+20*c 4 ≤ field r d c 5 := by
  ...
  change -48*c 2+20*c 3+38*c 5 ≤
    ...
    -43*c 3+20*c 4 ≤ -c 3+(20*c 2*c 0-20*c 3)-(20*c 3*c 1-20*c 4) ∧
    -41*c 4+2*c 5 ≤ -c 4+(20*c 3*c 1-20*c 4)-(20*c 4-2*c 5) ∧
    -24*c 5+20*c 4 ≤ -c 5+(20*c 4-2*c 5)-r*(c 5-c 2^2)
  constructor
  · nlinarith [hc 2]
  constructor
  · nlinarith [hc 3]
