import proofs.ThreeSitePhosphorylation.VariationalPaths
...
theorem variationField_apply (r T dr dT : ℝ) (u q : SourcePath) (t : UnitTime) :
    variationField r T dr dT u q t=
      T • jacobianOperator r (q t)+dT • jacobianOperator r (u t)+
        T • (dr • (jacobianOperator 1-jacobianOperator 0) (u t)) := by
...
theorem variational_ode (r T dr dT : ℝ) (x : ReducedState) (u q : SourcePath)
    ...
    HasDerivAt (integralVariation x (variationField r T dr dT u q))
      (T • jacobianOperator r (integralVariation x (variationField r T dr dT u q) t)+
        dT • jacobianOperator r (u ⟨t,ht⟩)+
          T • (dr • (jacobianOperator 1-jacobianOperator 0) (u ⟨t,ht⟩))) t := by
